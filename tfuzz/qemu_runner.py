...
class QEMURunner(object):
    ...
    def _run(self, stdout_file=None):
        print("[QEMURunner DEBUG] starting _run")
        ...
        with open('/dev/null', 'wb') as devnull:
            ...
            try:
                ...
                if type(self.input) == str:
                    ...
                    l.debug(" ".join(args))
                    print("[QEMURunner DEBUG] starting process")
                ...
                print("[QEMURunner DEBUG] ret value: " + str(ret))

                if ret < 0:
                    if abs(ret) == signal.SIGSEGV or abs(ret) == signal.SIGILL:
                        print("[QEMURunner DEBUG] crash was detected")
